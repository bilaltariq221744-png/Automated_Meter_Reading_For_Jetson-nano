...
VIDEO_PATH  = r"C:/Users/PMLS/Desktop/Meter_project/WhatsApp Video 2025-08-14 at 2.56.45 AM.mp4"   # ← CHANGE THIS to your video path
...
# Output Settings
SAVE_OUTPUT    = True            # Save output video with detections drawn
# Output will be written to the project folder
OUTPUT_PATH    = r"C:/Users/PMLS/Desktop/Automated_Meter_Reading_For_Jetson-nano/output_detected.mp4"  # Output video file name

SHOW_WINDOW    = True            # Show live detection window while processing
                                  # Set False if you just want to save without showing

# Processing Settings
PROCESS_EVERY_NTH_FRAME = 1     # Process every Nth frame
                                  # 1 = every frame (slower but smoother)
                                  # 3 = every 3rd frame (faster)
...
BOX_COLOR       = (0, 255, 0)    # Green box around LCD
TEXT_COLOR      = (0, 255, 0)    # Green text
CONF_BAR_COLOR  = (0, 200, 255)  # Orange confidence bar
...
def test_video():
    ...
    while True:
        ...
        if frame_count % PROCESS_EVERY_NTH_FRAME != 0:
            # Still write unprocessed frames to output
            if writer:
                writer.write(frame)
            continue
